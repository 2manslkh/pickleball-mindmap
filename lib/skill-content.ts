...
//
// Court coordinate system used by AnimSpec and the Court3D renderer:
//   x: sideline to sideline,  [-3.05 .. 3.05]   (court is ~6.1m / 20ft wide)
//   z: baseline to baseline,  [-6.7 .. 6.7]     (court is ~13.4m / 44ft long)
//   net at z = 0.  Kitchen (non-volley) lines at z = ±2.13 (7ft).
//   "You" play the near side (positive z); opponents the far side (negative z).
// Ball positions are [x, z] on the court plane; the renderer lifts the ball
// into a parabola of peak height `arc`.
...
export interface AnimSpec {
  ...
  from?: [number, number]; // ball start [x, z]
  to?: [number, number]; // ball end [x, z]
  arc?: number; // peak height of the ball path (court units); renderer has a per-template default
  spin?: 'top' | 'flat' | 'slice';
...
export const skillContent: Record<string, SkillContent> = {
  ...
  diff_balls: {
    ...
    anim: { template: 'dink', from: [1.2, 2.4], to: [-2.2, -1.8], arc: 0.7, spin: 'slice' },
  },
  exploit: {
    explanation:
  ...
  w1: {
    ...
    anim: { template: 'dink', from: [1.2, 2.4], to: [-1.9, -1.9], arc: 0.6, spin: 'slice' },
  },
  w2: {
    explanation:
  ...
  w3: {
    ...
    anim: { template: 'dink', from: [0.2, 2.4], to: [0, -1.9], arc: 0.6 },
  },
  w4: {
    explanation:
    ...
    anim: { template: 'crossCourt', from: [1.2, 2.4], to: [-2.7, -1.7], arc: 0.6 },
  },
  w5: {
    explanation:
    ...
    anim: { template: 'drive', from: [1.0, 3.0], to: [-1.4, -3.0], arc: 0.5, spin: 'top' },
  },
  w6: {
    explanation:
    ...
    anim: { template: 'dink', from: [1.2, 2.4], to: [1.3, -2.3], arc: 0.5 },
  },
  high_balls: {
    explanation:
    ...
    anim: { template: 'speedup', from: [0.8, 2.3], to: [-1.2, -2.5], arc: 0.25, spin: 'flat' },
  },
  at1: {
    explanation:
    ...
    anim: { template: 'speedup', from: [0.9, 2.3], to: [-1.0, -2.6], arc: 0.2, spin: 'flat' },
  },
  at2: {
    explanation:
    ...
    anim: { template: 'erne', from: [-1.6, -2.4], to: [2.9, 2.0], arc: 0.3 },
  },
  at3: {
    explanation:
    ...
    anim: { template: 'smash', from: [0, 2.0], to: [-1.5, -3.0], arc: 0.15, spin: 'flat' },
  },
  at4: {
    explanation:
    ...
    anim: { template: 'rollVolley', from: [0.8, 2.3], to: [-1.3, -2.4], arc: 0.45, spin: 'top' },
  },
  ...
  dr1: {
    ...
    anim: { template: 'dink', from: [1.2, 2.4], to: [-1.8, -1.9], arc: 0.55 },
  },
  dr2: {
    explanation:
    ...
    anim: { template: 'drop', from: [1.0, 5.8], to: [-1.0, -1.4], arc: 1.6 },
  },
  dr3: {
    explanation:
    ...
    anim: { template: 'blockReset', from: [-1.0, -2.5], to: [0.6, 1.0], arc: 0.5 },
  },
  mg1: {
    explanation:
    ...
    anim: { template: 'dink', from: [1.2, 2.4], to: [-1.5, -1.8], arc: 0.4 },
  },
  mg2: {
    explanation:
    ...
    anim: { template: 'drive', from: [1.0, 4.5], to: [-1.0, -3.2], arc: 0.35, spin: 'top' },
  },
  mg3: {
    explanation:
    ...
    anim: { template: 'serve', from: [1.2, 6.4], to: [-1.2, -5.6], arc: 1.0, highlight: [-1.2, -5.0, 2.2, 1.6] },
  },
  ss1: {
    explanation:
  ...
  ss2: {
    ...
    anim: { template: 'dink', concept: true, from: [0.8, 2.3], to: [-1.4, -1.9], arc: 0.4, note: 'Below the net? Reset, do not attack' },
  },
  def1: {
    explanation:
    ...
    anim: { template: 'blockReset', from: [-0.8, -2.5], to: [0.4, 0.9], arc: 0.45 },
  },
  def2: {
    explanation:
    ...
    anim: { template: 'blockReset', from: [-1.0, -2.6], to: [0.5, 1.1], arc: 0.4, note: 'Soft grip, give on contact' },
  },
  def3: {
    explanation:
    ...
    anim: { template: 'lob', from: [0.5, 3.2], to: [-0.5, -5.6], arc: 2.6 },
  },
  def4: {
    explanation:
    ...
    anim: { template: 'blockReset', concept: true, from: [-0.9, -2.5], to: [0.3, 1.0], arc: 0.45, note: 'Survive the point, do not force it' },
  },
  ...
  kc3: {
    ...
    anim: { template: 'drop', from: [1.0, 5.9], to: [-1.0, -1.3], arc: 1.7 },
  },
  kc4: {
    explanation:
    ...
    anim: { template: 'lob', from: [1.0, 2.4], to: [-1.2, -4.6], arc: 1.8 },
  },
  cg1: {
    explanation:
    ...
    anim: { template: 'crossCourt', from: [1.4, 2.4], to: [-1.9, -1.9], arc: 0.55 },
  },
  cg2: {
    explanation:
    ...
    anim: { template: 'downLine', from: [1.4, 2.4], to: [1.5, -1.9], arc: 0.5 },
  },
  cg3: {
    explanation:
    ...
    anim: { template: 'crossCourt', from: [0.4, 2.4], to: [-2.7, -1.6], arc: 0.55 },
  },
  fm1: {
    explanation:
  ...
  op1: {
    ...
    anim: { template: 'serve', from: [1.2, 6.4], to: [-1.2, -5.7], arc: 1.1, highlight: [-1.2, -5.4, 2.4, 1.2] },
  },
  op2: {
    explanation:
    ...
    anim: { template: 'return', from: [-1.2, -5.6], to: [1.2, 5.7], arc: 1.2, highlight: [1.2, 5.4, 2.4, 1.2] },
  },
  op3: {
    explanation:
  ...
  op4: {
    ...
    anim: { template: 'drop', from: [0.8, 4.0], to: [-1.0, -1.3], arc: 1.1, players: [
  ...
  in1: {
    ...
    anim: { template: 'speedup', from: [0.4, 2.3], to: [1.4, -2.5], arc: 0.25, spin: 'flat', note: 'Redirect to the other opponent' },
  },
  in2: {
    explanation:
    ...
    anim: { template: 'dink', concept: true, from: [1.0, 2.4], to: [-1.6, -1.9], arc: 0.5, note: 'Give them what they dislike' },
  },
  in3: {
    explanation:
  ...
  pr1: {
    ...
    anim: { template: 'dink', from: [1.0, 2.4], to: [-1.6, -1.9], arc: 0.38 },
  },
  pr2: {
    explanation:
    ...
    anim: { template: 'dink', from: [1.2, 2.4], to: [-1.4, -1.85], arc: 0.36 },
  },
  pr3: {
    explanation:
